...
/// 默认颜色
private let kLineColor : (CGFloat, CGFloat, CGFloat) = (47, 106, 255)
/// 选中颜色
private let kSelectColor : (CGFloat, CGFloat, CGFloat) = (36, 36, 36)
/// 滚动条颜色
private let kBottomLineColor : (CGFloat, CGFloat, CGFloat) = (255, 255, 255)//(240, 240, 240)
...
class YMPageTitleView: UIView {
    ...
    fileprivate lazy var scrollLine : UIView = {
        ...
        scrollLine.backgroundColor = UIColor(r: kLineColor.0, g: kLineColor.1, b: kLineColor.2)
        return scrollLine
    }()
