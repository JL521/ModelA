...
class TQDatePickerView: UIView {
    ...
    fileprivate lazy var title:UILabel = {
        let title = UILabel()
        title.text = "选择时间"
        title.textColor = UIColor.init(hex: 0x2A2C32)
        return title
    }()
    ...
    fileprivate lazy var cancelButton:UIButton = {
        ...
        cancelButton.titleLabel?.textColor = UIColor.init(hex: 0x2A2C32)
    ...
    fileprivate lazy var confirmButton:UIButton = {
        ...
        confirmButton.titleLabel?.textColor = UIColor.init(hex: 0x2A2C32)
...
//        }
    ...
    fileprivate func cancelP(){
        ...
        self.cancelButton.setTitleColor(UIColor.init(hex: 0x2A2C32), for: .normal)
...
//        }
    ...
    fileprivate func confirmButtonP(){
        ...
        self.confirmButton.setTitleColor(UIColor.init(hex: 0x2A2C32), for: .normal)
...
//        debugPrint("======取消按钮被点击=====")
    ...
    fileprivate func lineViewP(){
        ...
        self.lineView.backgroundColor = UIColor.init(hex: 0xAEB5C5)
    }
...
extension  TQDatePickerView:UIPickerViewDelegate,UIPickerViewDataSource{
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView {
        ...
        let label  = UILabel(frame: CGRect(x: kSCREEN_WIDTH * CGFloat(component) / 6 , y: 0, width: kSCREEN_WIDTH/6, height: 40))
        ...
        case 0:
            ...
            label.frame=CGRect(x:5, y:0,width:kSCREEN_WIDTH/4.0, height:40);
        ...
        case 1:
            ...
            label.frame=CGRect(x:kSCREEN_WIDTH/4.0, y:0,width:kSCREEN_WIDTH/8.0, height:40);
            
            
            label.text="\(row + 1)月";
        case 2:
            
            label.frame=CGRect(x:kSCREEN_WIDTH*3/8, y:0,width:kSCREEN_WIDTH/8.0, height:40);
        ...
        case 5:
            ...
            label.frame=CGRect(x:kSCREEN_WIDTH/6, y:0,width:kSCREEN_WIDTH/6.0 - 5, height:40);
