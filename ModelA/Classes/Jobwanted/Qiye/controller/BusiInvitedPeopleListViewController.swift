//
//  BusiInvitedPeopleListViewController.swift
//  Rencaiyoujia
//
...
class BusiInvitedPeopleListViewController: JobWantBaseViewController {
...
extension BusiInvitedPeopleListViewController{
...
extension BusiInvitedPeopleListViewController:UITableViewDelegate,UITableViewDataSource{
...
extension BusiInvitedPeopleListViewController {
    ...
    func getOfferList(status:String?) {
        ...
        JobRequestAPIProvider.rx.request(.getVuatebyState(parm)).mapObject(BaseArrayModel<BussRecivedResumeModel>.self).subscribe(onSuccess: { (value) in
